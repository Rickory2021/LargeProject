    ...
    return (
      <>
        <div className="flex flex-col justify-center items-center pt-48">
          ...
          <h2 className="text-black font-bold text-3xl pt-20">
            What is Slicer?
          </h2>
          <p className="text-xl p-11 max-w-md">
            Slicer is an inventory management software that takes away the
            stress of making sure that you and your team have enough stock to
            meet demands and avoid shortages. Slicer does the hard work for you
        ...
        <div className="flex flex-row justify-center items-center pt-44 space-x-24">
          <div className="card w-96 shadow-xl rounded-lg border-2 border-blue-600">
            <div className="card-body p-3 h-32">
              ...
              <p>Inventory updates in real time so you and your team can see current stocks and there restock dates</p>
            </div>
          </div>
          <div className="card w-96 shadow-xl rounded-lg border-2 border-blue-600">
            <div className="card-body p-3 h-32">
